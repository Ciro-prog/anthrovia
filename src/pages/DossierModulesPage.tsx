...
export default function DossierModulesPage() {
  ...
  const renderPhoneScreen = (moduleId: string) => {
    switch (moduleId) {
      ...
      case 'red-social':
        return (
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            {/* App Bar */}
            <div className="bg-primary text-white px-3 pt-6 pb-2 flex justify-between items-center shadow-sm">
      ...
      case 'noticias':
        return (
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            <div className="bg-primary text-white px-3 pt-6 pb-2 font-bold flex justify-between items-center shadow-sm">
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-2">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-slate-100">
                ...
                <div className="p-2">
                  ...
                  <button className="mt-2 text-secondary font-bold text-[8px] flex items-center gap-0.5">
              ...
              <div className="bg-white p-2 rounded-lg shadow-sm border border-slate-100 flex gap-2 items-center">
                <div className="w-10 h-10 bg-emerald-50 rounded flex-shrink-0 flex items-center justify-center text-primary">
        ...
        return (
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="p-1.5 bg-white border-t flex gap-1 items-center">
              ...
              <button className="w-5 h-5 bg-primary rounded-full text-white flex items-center justify-center">
            ...
            <div className="p-2 flex-1 overflow-y-auto space-y-2">
                  ...
                  {Array.from({ length: 31 }, (_, i) => {
                    ...
                    return (
                      <span
                        ...
                        } ${day === 23 ? 'bg-primary text-white font-bold' : ''}`}
                      >
                        {day}
                      </span>
                    );
              ...
              <div className="space-y-1">
                ...
                <div className="bg-white p-2 rounded-lg border border-slate-100 flex gap-2 items-center shadow-sm">
                  <div className="bg-emerald-50 text-primary font-bold text-center px-1.5 py-0.5 rounded leading-none">
          ...
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="flex-1 overflow-y-auto p-3 flex flex-col items-center justify-center gap-2">
              ...
              <div className="bg-white p-1.5 rounded border-2 border-[#124a43] shadow-sm text-center w-28">
                ...
                <p className="text-[6px] text-secondary uppercase font-bold">CEO & Fundador</p>
              </div>
              <div className="w-0.5 h-3 bg-primary/40"></div>
              <div className="w-32 border-t-2 border-[#124a43]/40 flex justify-between relative">
                <div className="absolute left-1/2 -top-0.5 -translate-x-1/2 w-0.5 h-3 bg-primary/40"></div>
              </div>
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div className="w-0.5 h-1 bg-primary/40"></div>
      ...
      case 'vacaciones':
        return (
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            <div className="bg-secondary text-white px-3 pt-6 pb-2 flex justify-between items-center shadow-sm">
            ...
            <div className="p-2 flex-1 overflow-y-auto space-y-3">
              ...
              <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm flex items-center justify-around gap-2">
                ...
                <div className="leading-tight">
                  <h6 className="font-bold text-[9px] text-secondary">Saldo disponible</h6>
              ...
              <div className="bg-white p-3 rounded-lg border border-slate-100 shadow-sm space-y-2">
                ...
                <button className="w-full bg-secondary text-white py-1.5 rounded font-bold text-[8px] hover:bg-secondary transition-colors">
                  Enviar Solicitud
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="p-2 flex-1 overflow-y-auto space-y-2">
              ...
              <div className="bg-red-50 p-2.5 rounded-lg border border-red-100 shadow-sm flex flex-col gap-1.5">
                ...
                <button className="bg-secondary text-white py-1 rounded font-bold text-[8px] flex items-center justify-center gap-1">
          ...
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="flex-1 overflow-y-auto p-2.5 space-y-3">
              ...
              <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm text-center flex flex-col items-center">
                <div className="w-10 h-10 rounded-full bg-slate-200 border-2 border-[#77574d] flex items-center justify-center font-bold text-secondary text-sm">JP</div>
          ...
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="p-3 flex-1 overflow-y-auto flex flex-col justify-center items-center text-center space-y-3">
              ...
              <div className="bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 rounded-xl p-4 w-full shadow-md space-y-2 relative overflow-hidden">
                ...
                <button className="bg-primary text-white px-3 py-1 rounded-full font-bold text-[7px] shadow-md flex items-center gap-1 mx-auto hover:bg-primary-container">
            ...
            <div className="p-2.5 flex-1 overflow-y-auto space-y-3 flex flex-col justify-center">
              <div className="bg-white border border-yellow-200 rounded-xl p-3 shadow-md flex flex-col gap-2 relative">
                ...
                <div className="flex gap-2 items-center">
                  <div className="w-6 h-6 rounded-full bg-primary text-white flex items-center justify-center font-bold text-[7px]">MP</div>
            ...
            <div className="p-2 flex-grow overflow-y-auto space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-white p-2 rounded-lg border border-slate-100 shadow-sm flex flex-col justify-between">
                  ...
                  <button className="w-full bg-primary text-white py-0.5 rounded mt-1.5 font-bold text-[6px]">Canjear</button>
                </div>
                <div className="bg-white p-2 rounded-lg border border-slate-100 shadow-sm flex flex-col justify-between">
          ...
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="p-2.5 flex-1 overflow-y-auto space-y-3">
              <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm space-y-2">
                <h6 className="font-bold text-[8px] text-secondary">Evaluación Semestral 2026</h6>
                {/* Competencies bars */}
        ...
        return (
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="p-2.5 flex-grow overflow-y-auto space-y-2.5">
              ...
              <div className="bg-white p-2.5 rounded-lg border border-slate-100 shadow-sm space-y-2">
                <div className="flex gap-2">
                  <div className="w-8 h-8 rounded bg-pink-100 text-secondary flex items-center justify-center flex-shrink-0"><span className="material-symbols-outlined text-base">lock</span></div>
                  <div>
                ...
                <button className="w-full bg-secondary text-white py-1 rounded font-bold text-[7px]">Continuar Módulo</button>
              </div>
            </div>
          </div>
        );
          ...
          <div className="flex flex-col h-full bg-slate-50 text-slate-800 text-[10px] font-sans">
            ...
            <div className="p-3 flex-1 overflow-y-auto flex flex-col justify-center space-y-3">
              <div className="bg-white p-3 rounded-lg border border-slate-100 shadow-sm space-y-3 text-center">
                ...
                <p className="font-bold text-[9px] text-secondary">¿Cómo calificarías el nivel de comunicación y apoyo de tu líder esta semana?</p>
                {/* Smiley face picker */}
                ...
                <button className="w-full bg-secondary text-white py-1 rounded font-bold text-[7px]">Enviar Respuesta</button>
              </div>
            </div>
          </div>
        );
  ...
  return (
    <div className="bg-background text-on-surface font-body selection:bg-primary-fixed selection:text-primary min-h-screen">
      ...
      <main>
        <section className="pt-32 md:pt-36 lg:pt-40 pb-8 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          <Link
            to="/dossier"
          ...
          <h1 className="font-heading text-headline-lg-mobile md:text-headline-lg text-on-surface mb-4">
            Explorá los módulos
          </h1>
          <p className="font-body text-body-lg text-on-surface-variant max-w-2xl">
            Suite interactiva de 22 módulos en 5 categorías. Seleccioná un módulo para ver la simulación
            en el teléfono; en mobile deslizá el carrusel.
          </p>
        </section>

        {/* Modules Section */}
        <section className="py-12 md:py-16 bg-surface relative" id="modulos">
          <div ref={containerRef} className="relative max-w-[1440px] mx-auto px-6 md:px-16 space-y-24 z-10">
            {pathD && (
              <svg className="absolute inset-0 w-full h-full pointer-events-none z-0 hidden lg:block">
                ...
                <path d={pathD} fill="none" stroke="#003737" strokeOpacity="0.08" strokeWidth="6" />
                ...
                <defs>
                  <linearGradient id="gradient-line" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#003737" />
                    <stop offset="25%" stopColor="#6b5c4c" />
                    <stop offset="50%" stopColor="#474745" />
                    <stop offset="75%" stopColor="#003737" />
                    <stop offset="100%" stopColor="#6b5c4c" />
                  </linearGradient>
                </defs>
              </svg>
            )}
                  ...
                  <div className="hidden lg:grid lg:grid-cols-12 gap-12 items-center">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <h3 className="text-xl md:text-2xl font-bold text-on-surface font-headline-md leading-tight mt-1">
                            {category.title}
                          </h3>
                        </div>
                      </div>

                      <p className="text-xs text-on-surface-variant mb-6">{category.description}</p>
                      ...
                      {activeModule && (
                        ...
                        >
                          <div>
                            <h4 className="font-bold text-sm text-on-surface">{activeModule.title}</h4>
                          ...
                          <div className="grid sm:grid-cols-2 gap-2 pt-2 border-t border-slate-50">
                            {activeModule.keyFeatures.map((feat, fIdx) => (
                              <div key={fIdx} className="flex items-center gap-1.5 text-[9px] text-on-surface-variant">
                    ...
                    >
                      ...
                      <div
                        ...
                        className="w-[240px] border-[6px] border-[#1b1c1c] rounded-[2.5rem] bg-[#1b1c1c] aspect-[9/19] shadow-2xl relative overflow-hidden flex flex-col transition-transform duration-500 hover:scale-[1.02] cursor-pointer group/phone"
                        style={{
                          boxShadow: `0 25px 60px -15px ${categoryColorTheme}25`,
                        }}
                      >
                        {/* Notch / Dynamic Island */}
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-28 h-4 bg-[#1b1c1c] rounded-b-xl z-20 flex items-center justify-center">
                  ...
                  <div className="lg:hidden space-y-6">
                    ...
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <div>
                        ...
                        <h3 className="text-lg font-bold text-on-surface font-headline-md leading-tight mt-0.5">
                          {category.title}
                        </h3>
                      </div>
                    </div>
                      ...
                      {category.modules.map((m) => (
                        ...
                        >
                          <div className="space-y-1.5">
                            ...
                            <h4 className="font-bold text-xs text-on-surface mt-1">{m.title}</h4>
          ...
          >
            ...
            >
              ...
              <div className="flex-grow flex justify-center items-center relative py-4 min-h-[340px] md:min-h-[440px] select-none">
                ...
                {/* iPhone Frame */}
                <div 
                  className="w-[200px] md:w-[240px] border-[6px] border-[#1b1c1c] rounded-[2.5rem] bg-[#1b1c1c] aspect-[9/19] shadow-2xl relative overflow-hidden flex flex-col"
